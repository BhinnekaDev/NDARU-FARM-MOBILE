...
export const useFacilityAnimations = (scrollY: Animated.Value) => {
  ...
  const backgroundColor = scrollY.interpolate({
    inputRange: [390, 400],
    outputRange: [
      colorScheme === "dark" ? "rgba(19, 21, 20, 0)" : "rgba(255, 255, 255, 0)",
      colorScheme === "dark" ? "rgba(19, 21, 20, 1)" : "rgba(255, 255, 255, 1)",
    ],
    extrapolate: "clamp",
  });
  ...
  const bottomBackgroundColor = scrollY.interpolate({
    inputRange: [620, 690],
    outputRange: [
      colorScheme === "dark" ? "#33383610" : "#00000010",
      colorScheme === "dark" ? "#333836" : "#000000",
    ],
    extrapolate: "clamp",
  });
